  ...
  useEffect(() => {
    const fetchMessages = async () => {
      ...
      try {
        ...
        const res = await fetch(`http://localhost:5050/tickets/${encodeURIComponent(ticketId)}/messages`, {
  ...
  const handleSend = async (e) => {
    ...
    try {
      ...
      if (image) {
        ...
        res = await fetch(`http://localhost:5050/tickets/${encodeURIComponent(ticketId)}/messages`, {
          method: 'POST',
          headers: {
